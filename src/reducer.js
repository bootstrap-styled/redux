...
import { CHANGE_THEME, CHANGE_THEME_SUCCESS, INSERT_THEME, UPDATE_THEME, DELETE_THEME } from './constants';
...
export default (state = initialState, action) => {
  switch (action.type) {
    case CHANGE_THEME: {
      ...
      if (Object.keys(state['bs.redux'].themes).indexOf(action.theme._name) === -1) { // eslint-disable-line no-underscore-dangle
